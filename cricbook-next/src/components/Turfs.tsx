...
const Turfs = () => {
  ...
  useEffect(() => {
    const fetchTurfs = async () => {
      try {
        const TURF_URL = process.env.NEXT_PUBLIC_TURF_URL || '';
        const res = await fetch(`${TURF_URL}/turfs`);
        if (res.ok) {
                  ...
                  <div className="fk-form mt-4">
                    ...
                    <div className="form-grid mt-3">
                      ...
                      <div className="form-group">
                        ...
                        <input type="date" className="form-control" value={date} onChange={e => { setDate(e.target.value); setTime(''); }} min={todayStr} required />
                      </div>
                      <div className="form-group">
